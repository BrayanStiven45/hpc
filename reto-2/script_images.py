...
plt.grid()
plt.savefig(os.path.join(output_dir, "speedup_m1.png"))
...
plt.grid()
plt.savefig(os.path.join(output_dir, "speedup_m2.png"))
...
plt.legend()
plt.grid()
plt.savefig(os.path.join(output_dir, "openmp_comparison.png"))
...
plt.legend()
plt.grid()
plt.savefig(os.path.join(output_dir, "sequential_comparison.png"))
...
# -------------------------
table_m1_openmp.to_csv(os.path.join(output_dir, "table_m1_openmp.csv"), index=False)
table_m1_seq.to_csv(os.path.join(output_dir, "table_m1_seq.csv"), index=False)
table_m2_openmp.to_csv(os.path.join(output_dir, "table_m2_openmp.csv"), index=False)
table_m2_seq.to_csv(os.path.join(output_dir, "table_m2_seq.csv"), index=False)

table_m1_speedup.to_csv(os.path.join(output_dir, "table_m1_speedup.csv"), index=False)
table_m2_speedup.to_csv(os.path.join(output_dir, "table_m2_speedup.csv"), index=False)